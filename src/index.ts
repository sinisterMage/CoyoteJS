...
//
// Prefer the subpath imports (`coyote-js/reactivity`, `coyote-js/dom`, …) in
// app code; this barrel re-exports everything for convenience.
...
// The automatic JSX runtime (`jsxImportSource: 'coyote-js'` resolves
// `coyote-js/jsx-runtime`).
